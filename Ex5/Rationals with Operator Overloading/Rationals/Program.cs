...
namespace Rationals {
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"rat1.ToString() = {rat1.ToString()}");
            rat1.Reduce();
            Console.WriteLine($"rat1.Reduce() = {rat1.ToString()}");
            Rational rat2 = new Rational(16,4);
            Console.WriteLine($"rat2.ToString() = {rat2.ToString()}");
            Console.WriteLine($"rat2.Equals(rat1) = {rat2.Equals(rat1).ToString()}");
            Rational rat3 = new Rational(1,2);
            Console.WriteLine($"rat3.ToString() = {rat3.ToString()}");
            Rational rat4 = rat3.Mul(rat1);
            Console.WriteLine($"rat4 = rat3 * rat1 => {rat4.ToString()}");
            rat4.Reduce();
            Console.WriteLine($"rat4.Reduce() = {rat4.ToString()}");
            Rational rat5 = rat3.Add(rat2);
            Console.WriteLine($"rat5 = rat3.Add(rat2) => {rat5.ToString()}");
            rat5.Reduce();
            Console.WriteLine($"rat5.Reduce() = {rat5.ToString()}");
            ...
            Rational ratDoubleCasting = (Rational)9;
            double doubleRat = ratDoubleCasting;
        }
    }
}
